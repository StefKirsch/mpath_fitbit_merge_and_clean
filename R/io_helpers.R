read_data_catergory_and_cleanup <- function(folder_list, pattern_in_path, in_folder = NA, cleanup_temp_dir = FALSE) {
  ...
  df <- get_data_from_path_list_dt(
    path_list = matching_files,
    pattern_in_path = pattern_in_path
    )
...
get_data_from_path_list_df <- function(path_list, pattern_in_path) {
  # with map
